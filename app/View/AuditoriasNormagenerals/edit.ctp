...
<?php echo $this->Form->create('AuditoriasNormageneral'); ?>
	<fieldset>
		<legend><?php echo __('Edit Auditorias Normageneral'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AuditoriasNormageneral.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('AuditoriasNormageneral.id')))); ?></li>
