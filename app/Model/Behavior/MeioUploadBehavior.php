 ...
 */
	var $defaultOptions = array(
		...
		'maxSize' => 2097152, // 2MB
		'allowedMime' => array('image/jpeg', 'image/pjpeg', 'image/png', 'image/gif', 'image/bmp', 'image/x-icon', 'image/vnd.microsoft.icon','application/pdf', 'application/vnd.ms-word', 'application/vnd.ms-powerpoint', 'application/vnd.ms-excel','application/rtf', 'application/zip'),
		'allowedExt' => array('.jpg', '.jpeg', '.png', '.gif', '.bmp', '.ico','.pdf', '.docx', '.ppt', '.xls','.rtf', '.zip', '.doc'),
