...
<div class="panel panel-success">
    <div class="panel-heading">
        <h3 class="panel-title text-center">REGISTRAR EMPRESA</h3>
    </div>
...
<?php echo $this->Form->create('Empresa'); ?>
	...
	<?php
		...
		if($userTipo==1){
		echo $this->Form->input('tratamiento',array('value'=>'consultora','type'=>'hidden','required'=>'true'));}
		else{
		echo $this->Form->input('tratamiento',array('value'=>'cliente','type'=>'hidden','required'=>'true'));}
	?>
    ...
    <div class="col-md-4">
	<?php
	        echo $this->Form->input('estado',array('value'=>'Activo','type'=>'hidden','required'=>'true'));
        ...
        <input class='form-control' type='date' name='data[Empresa][Finicio]' required='true'>
        <?php endif;?>
    </div>
	...
	<label>Fecha Termino del Uso</label>
        <input class='form-control' type='date' name='data[Empresa][Ftermino]' required ='true'>
        <?php endif;?>
