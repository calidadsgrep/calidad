<div class="listas index">
	...
	<tr>
		<td>
			<?php echo $lista['Debe']['numeral'].'-'. $lista['Debe']['descripcion']; ?>
		</td>
                <td>
			<?php echo $lista['Lista']['observaciones']; ?>
		</td>
                <td>
			<?php echo $lista['Lista']['tipo']; ?>
		</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $lista['Lista']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $lista['Lista']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
